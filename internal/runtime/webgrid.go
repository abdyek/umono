...
func GenerateGridCSS(inputHTML string) (string, error) {
	...
	css.WriteString("compono-image,picture,img{box-sizing:border-box;max-width:100%;width:100%;}\n")
	css.WriteString("compono-image,picture{display:block;}\n")
	css.WriteString("compono-image>picture,compono-image>img,picture>img{display:block;height:auto;}\n")
